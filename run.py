        ...
        if choice == '1':
            ...
            while True:
                ...
                if pw_input_choice == '1':
                    pw_length = int(
                        input('Enter desired autogenerated password length: '))
                    password = generate_pw(pw_length)
                    print(
                        f'Autogenerated password is {password} \nYou will need to remember this.')
                    break
                ...
                while True:
                    ...
                    if selection == '1':
                        ...
                        new_account = create_account(
                            name, email, usrnm, acc_pw, user_logged_in.username)
                    ...
                    # Existing credentials.
                        ...
                        if accounts:
                            print('\n\n***Delete Credential***\n\n')
                            acc_name = input(
                                'Enter name of credential to delete: ')
                            for account in accounts:
                            ...
                            print(
                                'Credential does not exist, please check your spelling.')
                            accounts = []
                        else:
                    ...
                    for user in users:
                        if user.username == del_usrname:
                            ...
                            if confirm == 'y':
                                ...
                                print(
                                    "I didn't quite get that. Please enter 'y' or 'n' for yes or no.\n\n")
            else:
